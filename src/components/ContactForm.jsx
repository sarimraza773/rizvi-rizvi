...
/**
 * A simple contact form that uses the mailto: protocol to send the
 * message via the user's default email client.  Basic validation
 * ensures all fields are populated before the link is triggered.
 */
