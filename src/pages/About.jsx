...
export default function About() {
  return (
    <>
      <Seo
        title="About"
        description="About Rizvi&Rizvi — a Karachi-based privately held law firm highlighting 30+ years of trusted client relationships."
      />
      ...
      <Section eyebrow="Approach" title="How we work">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-8">
          <p className="text-ink-200/80 leading-relaxed max-w-4xl">
            ...
            This website is designed to stay fast and minimal, with smooth animations and direct navigation
            inspired by modern global law firm interfaces.
          </p>
        </div>
      </Section>
    </>
